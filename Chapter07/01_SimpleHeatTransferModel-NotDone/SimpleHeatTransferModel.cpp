...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	MSG			msg;
	WNDCLASSEX	wndclass;
	TCHAR		szAppName[] = TEXT("CUDA Simple Heat Transfer Model");
	HWND		hwnd;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Simple Heat Transfer Simulation"),
...
void loadTexture(void)
{
	void InitializeGPU(int, unsigned char*, FILE*);

	// code

	// CUDA
	InitializeGPU(CHECK_IMAGE_WIDTH, CheckImage, gpFile);
